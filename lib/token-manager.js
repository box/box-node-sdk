...
TokenManager.prototype = {
	 ...
	 * @returns {void}
	 */
	getTokensClientCredentialsGrant: function(options, callback) {
	 ...
	 * @returns {void}
	 */
	getTokensRefreshGrant: function(refreshToken, options, callback) {
		if (typeof options === 'function') {
			callback = options;
			options = null;
		}
	 ...
	 * @returns {void}
	 */
	getTokensJWTGrant: function(type, id, options, callback) {
		if (typeof options === 'function') {
			callback = options;
			options = null;
		}
	 ...
	 * @returns {void}
	 */
	exchangeToken: function(accessToken, scopes, resource, options, callback) {
		if (typeof options === 'function') {
			callback = options;
			options = null;
		}
		...
		this.getTokens(params, options, callback);
	},
	 ...
	 * @returns {void}
	 */
	revokeTokens: function(token, options, callback) {
		var params = {
			method: 'POST',
