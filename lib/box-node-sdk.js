...
var EventEmitter = require('events').EventEmitter,
	...
	TokenStore = require('./util/token-store'),
...
/**
 * Create the in-memory token store instance for the user
 *
 * @param {string} userId the ID of the user whose token info can be persisted in-memory.
 * @returns {TokenStore} A new TokenStore instance
 */
BoxSDKNode.prototype.getTokenStore = function(userId) {
	return new TokenStore(userId);
};
