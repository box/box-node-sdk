...
var EventEmitter = require('events').EventEmitter,
	...
	MemoryTokenStore = require('./util/memory-token-store'),
...
/**
 * MemoryTokenStore is a default implementation of persistent token store
 * @static
 * @type {MemoryTokenStore}
 */
BoxSDKNode.MemoryTokenStore = MemoryTokenStore;
