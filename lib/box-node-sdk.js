 ...
 */
BoxSDKNode.prototype.getTokensAuthorizationCodeGrant = function(authorizationCode, options) {
 ...
 * @returns {Promise<TokenInfo>} Promise resolving to the token info
 */
BoxSDKNode.prototype.getTokensRefreshGrant = function(refreshToken, options) {
 ...
 * @returns {Promise<TokenInfo>} Promise resolving to the token info
 */
BoxSDKNode.prototype.getEnterpriseAppAuthTokens = function(enterpriseID, options) {
 ...
 */
BoxSDKNode.prototype.getAppUserTokens = function(userID, options) {
 ...
 * @returns {Promise<TokenInfo>} Promise resolving to the token info
 */
BoxSDKNode.prototype.revokeTokens = function(token, options) {
