 ...
 *
 * @param {object} appConfig boxAppSettings json is passed as parameter.
 * @returns {BoxSDKNode} the BoxSDKNode instance
 */
BoxSDKNode.getPreconfiguredInstance = function(appConfig) {
	...
	if (typeof boxAppSettings.webhooks === 'object') {

		var primaryKey = boxAppSettings.webhooks.primaryKey;
		if (typeof primaryKey === 'string') {
			Webhooks.setPrimarySignatureKey(primaryKey);
		}

		var secondaryKey = boxAppSettings.webhooks.secondaryKey;
		if (typeof secondaryKey === 'string') {
			Webhooks.setSecondarySignatureKey(secondaryKey);
		}
	}
	...
	if (typeof boxAppSettings.appAuth === 'object') {
		...
		var appAuth = {};
		var keyID = boxAppSettings.appAuth.publicKeyID;
	...
	if (typeof boxAppSettings.enterpriseID === 'string') {
		params.enterpriseID = boxAppSettings.enterpriseID;
	}
...
/**
 * Configures additional properties passed as parameter.
 *
