...
/**
 * Gets Lower scoped token for the given token
 * @param {string} accessToken that has broader scope
 * @param {string} scope the space delimited scopes that defines the scope of the new token.
 *   The scopes that are supported are item_read, item_readwrite, item_preview, item_upload,
 *   item_share, item_delete, item_download
 * @param {string} resource the full URL of the resource
 * @param {Function} callback Passed the tokens if successful
 * @returns {void}
 */
BoxSDKNode.prototype.getLowerScopedToken = function(accessToken, scope, resource, callback) {
	this.tokenManager.getLowerScopedToken(accessToken, scope, resource, callback);
};
