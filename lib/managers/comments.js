 ...
 */
Comments.prototype.get = function(commentID, options) {
	var params = {
		qs: options
	};
 ...
 */
Comments.prototype.create = function(fileID, commentBody) {
 ...
 * @returns {Promise<Object>} A promise resolving to the new comment object
 */
Comments.prototype.createTaggedComment = function(fileID, commentBody) {
	var params = {
		body: {
			item: {
				type: 'file',
 ...
 */
Comments.prototype.update = function(commentID, updates) {
	var params = {
		body: updates
	};
