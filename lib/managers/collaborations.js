 ...
 */
Collaborations.prototype.get = function(collaborationID, options) {
	var params = {
		qs: options
	};
 ...
 */
Collaborations.prototype.getPending = function() {
	var params = {
		qs: {
			status: 'pending'
		}
	};
	return this.client.wrapWithDefaultHandler(this.client.get)(BASE_PATH, params);
};
 ...
 */
Collaborations.prototype.update = function(collaborationID, updates) {
	var params = {
		body: updates
	};
 ...
 */
Collaborations.prototype.respondToPending = function(collaborationID, newStatus) {
	var options = {
		status: newStatus
	};
	return this.update(collaborationID, options);
};
 ...
 */
Collaborations.prototype.create = function(accessibleBy, itemID, role, options) {
 ...
 * @returns {Promise<Object>} A promise resolving to the created collaboration object
 */
Collaborations.prototype.createWithUserID = function(userID, itemID, role, options) {

	var accessibleBy = {
		type: 'user',
		id: userID
	};
	return this.create(accessibleBy, itemID, role, options);
};
 ...
 * @returns {Promise<Object>} A promise resolving to the created collaboration object
 */
Collaborations.prototype.createWithUserEmail = function(email, itemID, role, options) {
 ...
 * @returns {Promise<Object>} A promise resolving to the created collaboration object
 */
Collaborations.prototype.createWithGroupID = function(groupID, itemID, role, options) {
 ...
 */
Collaborations.prototype.delete = function(collaborationID) {
