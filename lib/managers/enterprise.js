 ...
 */
Enterprise.prototype.getUsers = function(options) {
 ...
 */
Enterprise.prototype.inviteUser = function(enterpriseID, email) {
 ...
 */
Enterprise.prototype.addUser = function(login, name, options) {
 ...
 * @returns {Promise<Object>} A promise resolving to the created user
 */
Enterprise.prototype.addAppUser = function(name, options) {
 ...
 */
Enterprise.prototype.transferUserContent = function(sourceUserID, destUserID) {
