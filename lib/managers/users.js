 ...
 * Method: PUT
 *
 * @param {string} userID - The ID of the user to change login for
 * @param {string} email - The email alias to become the primary email
 * @param {Function} callback - Passed the updated user information if successful, error otherwise
 * @returns {void}
 */
Users.prototype.changeLogin = function(userID, email, callback) {
