 ...
 */
Users.prototype.get = function(userID, options) {
 ...
 */
Users.prototype.update = function(userID, updates) {
	var apiPath = urlPath(BASE_PATH, userID),
		params = {
			body: updates
		};
 ...
 */
Users.prototype.delete = function(userID, options) {
	var apiPath = urlPath(BASE_PATH, userID),
		params = {
			qs: options
		};
 ...
 */
Users.prototype.getEmailAliases = function(userID) {
 ...
 */
Users.prototype.addEmailAlias = function(userID, email, options) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Users.prototype.removeEmailAlias = function(userID, aliasID) {
 ...
 */
Users.prototype.getGroupMemberships = function(userID, options) {
