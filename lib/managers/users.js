 ...
 * @param {Object} [qs] - Optional additional querystring to add to the request. Can be left null in most cases.
 * @param {boolean} [qs.notify] - Determines if the destination user should receive email notification of the transfer.
 * @param {boolean} [qs.force] - Whether or not the user should be deleted even if this user still own files.
