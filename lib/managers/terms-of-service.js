 ...
 * @param {TermsOfServicesStatus} [options.termsOfServiceStatus] - Determine if the custom terms of service is scoped internall or externally to an enterprise
 * @param {string} [options.termsOfServiceText] - Text field for message associated with custom terms of services
...
TermsOfService.prototype.update = function(termsOfServicesID, options, callback) {
	var params = {
		body: {
			status: options.termsOfServiceStatus,
			text: options.termsOfServiceText
		}
	};
