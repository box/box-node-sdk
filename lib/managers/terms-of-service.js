 ...
 * @returns {Promise<Object>} A promise resolving to the terms of services object
 */
TermsOfService.prototype.update = function(termsOfServicesID, termsOfServicesStatus, termsOfServicesText, callback) {
	var params = {
		body: {
			status: termsOfServicesStatus,
			text: termsOfServicesText
 ...
 * @param {Object} [options] - Additional options. Can be left null in most cases.
 * @param {string} [options.userID] - Optional, user id to retrieve terms of service status on, default is current user
 ...
 */
TermsOfService.prototype.createUserStatuses = function(termsOfServicesID, isAccepted, options, callback) {
	var params = {
		body: {
			tos: {
	...
	if (options.userID) {
		...
		Object.assign(params.body.user, user);
	}
 ...
 * @returns {Promise<Object>} A promise resolving to the terms of service user status
 */
TermsOfService.prototype.getUserStatuses = function(termsOfServicesID, options, callback) {
	var params = {
		qs: {
			tos_id: termsOfServicesID
		}
 ...
 * Method: PUT
 *
 * @param {string} termsOfServiceUserStatusesID - Terms of service user status object ID
 * @param {bool} isAccepted - Determines wehether the terms of services has been accepted or rejected
 ...
 */
TermsOfService.prototype.updateUserStatuses = function(termsOfServiceUserStatusesID, isAccepted, callback) {
	var params = {
		body: {
			is_accepted: isAccepted
		}
 ...
 * @returns {Promise<Object>} A promise resolving to the terms of service user status
 */
TermsOfService.prototype.setUserStatuses = function(termsOfServicesID, isAccepted, options, callback) {
	var params = {
		body: {
			tos: {
				tos_id: termsOfServicesID,
	...
	return this.client.post(apiPath, params)
		.then(response => {
			...
			case httpStatusCodes.CONFLICT:
				return this.updateUserStatuses(termsOfServicesID, isAccepted);
