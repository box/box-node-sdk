 ...
 *
 * @param {string} fileID - Box ID of the file being requested
 * @param {string[]} representationTypes - The x-rep-hints value the application should create a
 *    representation for
 * @param {Object} [options] - Additional options. Can be left null in most cases.
 ...
 *    for Box files
*/
Files.prototype.getRepresentations = function(fileID, representationTypes, options, callback) {
	var params = {
		qs: {
