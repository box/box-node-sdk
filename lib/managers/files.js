 ...
 *
 * @param {string} fileID - Box ID of the file being requested
 * @param {Object} qs - Set fields to 'representations' in order to retrieve generated representations for a Box file
 * @param {Object} headers - The request headers of the get representation request
 * @param {Function} [callback] - Passed  a url link to download the representation that was generated
 * @returns {Promise<Object>} A promise resolving to the url links to of all file representations generated for Box files
*/
Files.prototype.get = function(fileID, header, qs, callback){
  var params = {
    qs: 'representations',
    headers: {
      'x-rep-hints': header
