 ...
 * @param {string} fileID - Box ID of the file being requested
 * @param {Object} [options] - Additional options for the request. Can be left null in most cases.
 * @param {string} [options.extension] - The file format for the thumbnail. Default is png.
...
Files.prototype.getThumbnail = function(fileID, options, callback) {
	...
	if (options && options.extension) {		
		if (['png', 'jpg'].indexOf(options.extension) !== -1) {
	...
	var apiPath = urlPath(BASE_PATH, fileID, `/thumbnail.${extension}`);
