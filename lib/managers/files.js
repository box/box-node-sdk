 ...
 *
 * API Endpoint: '/files/upload-session/:sessionID/commit'
 * Method: POST
 *
 ...
 * finished committing
 *
 * API Endpoint: '/files/upload-session/:sessionID/status'
 * Method: GET
 *
...
Files.prototype.getChunkedUploader = function(folderID, size, name, file, options, callback) {
	...
	var self = this;
	this.createUploadSession(folderID, size, name, function(err, sessionInfo) {
...
Files.prototype.getNewVersionChunkedUploader = function(fileID, size, file, options, callback) {
	...
	var self = this;
	this.createNewVersionUploadSession(fileID, size, function(err, sessionInfo) {
