 ...
 */
Files.prototype.get = function(fileID, options) {
	var params = {
		qs: options
	};
 ...
 */
Files.prototype.getDownloadURL = function(fileID, options) {
	var params = {
		qs: options
	};
 ...
 */
Files.prototype.getReadStream = function(fileID, options) {
 ...
 */
Files.prototype.getThumbnail = function(fileID, options) {
	var params = {
		qs: options,
		responseType: 'blob'
	};
 ...
 */
Files.prototype.getComments = function(fileID, options) {
	var params = {
		qs: options
	};
 ...
 */
Files.prototype.update = function(fileID, updates) {
	var params = {
		body: updates
	};
 ...
 */
Files.prototype.addToCollection = function(fileID, collectionID) {
 ...
 * @returns {Promise<Object>} A promise resolving to the updated file object
 */
Files.prototype.removeFromCollection = function(fileID, collectionID) {
 ...
 * @returns {Promise<Object>} A promise resolving to the updated file object
 */
Files.prototype.move = function(fileID, newParentID) {
	var params = {
		body: {
			parent: {
				id: newParentID
 ...
 */
Files.prototype.copy = function(fileID, newParentID, options) {
 ...
 */
Files.prototype.delete = function(fileID) {

	var apiPath = urlPath(BASE_PATH, fileID);
	return this.client.wrapWithDefaultHandler(this.client.del)(apiPath, null);
};
 ...
 */
Files.prototype.preflightUploadFile = function(parentFolderID, fileData, options) {
	var params = {
		body: {
			parent: {
				id: parentFolderID
	...
	return this.client.wrapWithDefaultHandler(this.client.options)(apiPath, params);
};
 ...
 * @returns {Promise<Object>} A promise resolving to the upload data
 */
Files.prototype.preflightUploadNewFileVersion = function(fileID, fileData, options) {
	var params = {
		qs: options
	};
 ...
 */
Files.prototype.promoteVersion = function(fileID, versionID) {
 ...
 */
Files.prototype.uploadFile = function(parentFolderID, filename, content, options) {
	...
	return this.client.wrapWithDefaultHandler(this.client.upload)(apiPath, null, multipartFormData);
};
 ...
 * @returns {Promise<Object>} A promise resolving to the uploaded file
 */
Files.prototype.uploadNewFileVersion = function(fileID, content, options) {
 ...
 */
Files.prototype.getAllMetadata = function(fileID) {
 ...
 */
Files.prototype.getMetadata = function(fileID, scope, template) {
 ...
 */
Files.prototype.addMetadata = function(fileID, scope, template, data) {
 ...
 */
Files.prototype.updateMetadata = function(fileID, scope, template, patch) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Files.prototype.deleteMetadata = function(fileID, scope, template) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Files.prototype.deletePermanently = function(fileID) {
 ...
 */
Files.prototype.getTrashedFile = function(fileID, options) {
 ...
 */
Files.prototype.getTasks = function(fileID, options) {
 ...
 */
Files.prototype.getEmbedLink = function(fileID) {
 ...
 */
Files.prototype.lock = function(fileID, options) {
 ...
 */
Files.prototype.unlock = function(fileID) {
 ...
 */
Files.prototype.restoreFromTrash = function(fileID, options) {
 ...
 */
Files.prototype.getVersions = function(fileID, options) {
 ...
 */
Files.prototype.getWatermark = function(fileID, options) {
 ...
 * @returns {Promise<Object>} A promise resolving to the watermark info
 */
Files.prototype.applyWatermark = function(fileID, options) {
	var apiPath = urlPath(BASE_PATH, fileID, WATERMARK_SUBRESOURCE),
		params = {
			body: {
				watermark: {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Files.prototype.removeWatermark = function(fileID) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Files.prototype.deleteVersion = function(fileID, versionID) {
 ...
 */
Files.prototype.createUploadSession = function(folderID, size, name) {
	...
	return this.client.wrapWithDefaultHandler(this.client.post)(apiURL, params);
};
 ...
 * @returns {Promise<Object>} A promise resolving to the new upload session object
 */
Files.prototype.createNewVersionUploadSession = function(fileID, size) {
 ...
 */
Files.prototype.uploadPart = function(sessionID, part, offset, totalSize) {
	...
	// @TODO(mwiller) 2018-01-24: Use wrapWithDefaultHandler()
 ...
 */
Files.prototype.commitUploadSession = function(sessionID, fileHash, options) {
	...
	return (userParts ? Promise.resolve(userParts) : fetchParts(0, []))
		.then(parts => {
			...
			if (response.statusCode === 202) {
				...
				return new Promise(resolve => setTimeout(resolve, retryInterval * 1000))
					.then(() => {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Files.prototype.abortUploadSession = function(sessionID) {

	var apiURL = this.client._uploadBaseURL + urlPath(BASE_PATH, UPLOAD_SESSION_SUBRESOURCE, sessionID);

	return this.client.wrapWithDefaultHandler(this.client.del)(apiURL);
};
 ...
 */
Files.prototype.getUploadSessionParts = function(sessionID, options) {
	...
	return this.client.wrapWithDefaultHandler(this.client.get)(apiURL, params);
};
 ...
 */
Files.prototype.getUploadSession = function(sessionID) {

	var apiURL = this.client._uploadBaseURL + urlPath(BASE_PATH, UPLOAD_SESSION_SUBRESOURCE, sessionID);

	return this.client.wrapWithDefaultHandler(this.client.get)(apiURL);
};
 ...
 */
Files.prototype.getChunkedUploader = function(folderID, size, name, file, options) {
 ...
 * @returns {Promise<ChunkedUploader>} A promise resolving to the chunked uploader
 */
Files.prototype.getNewVersionChunkedUploader = function(fileID, size, file, options) {
 ...
 */
Files.prototype.getCollaborations = function(fileID, options) {
	var params = {
		qs: options
	};
...
*/
Files.prototype.getRepresentationInfo = function(fileID, representationType) {
	var params = {
		qs: {
