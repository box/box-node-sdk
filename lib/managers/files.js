...
/**
 * Requests a file object at the given absolute or relative path
 *
 * API Endpoint: '/files?path=:path'
 * Method: GET
 *
 * @param {string} path - The path to the file requested
 * @param {Object} [options] - Optional parameters
 * @param {string} [options.parent_id] - If the path is relative, the ID of the folder it should be relative to
 * @param {string} [options.fields] - Comma-separated list of fields to display on the file object
 * @param {Function} [callback] - Passed the file information if call was successful
 * @returns {Promise<Object>} A promise resolving to the file object
 */
Files.prototype.getByPath = function(path, options, callback) {
