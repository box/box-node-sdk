 ...
 * @param {string} parentFolderID - the id of the parent folder to upload to
 * @param {string} filename - the file name that the uploaded file should have
 * @param {string} path - the full path of the file that needs to be uploaded. The path includes the filename
 * @param {Function} callback - called with data about the upload if successful, or an error if the
 * upload failed
 * @returns {void}
 */
Files.prototype.uploadFileFromPath = function(parentFolderID, filename, path, callback) {
	...
	this.uploadFile(parentFolderID, filename, stream, callback);
};
 ...
 * @returns {void}
 */
Files.prototype.uploadNewFileVersionFromPath = function(fileID, path, callback) {
	...
	this.uploadNewFileVersion(fileID, stream, callback);
};
