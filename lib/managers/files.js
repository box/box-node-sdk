...
/**
 * Discards a specific file version to the trash. Depending on the enterprise settings for this user,
 * the item will either be actually deleted from Box or moved to the trash.
 *
