...
Metadata.prototype = {
	...
	/**
	 * Get metadata template with a given ID
	 *
	 * API Endpoint: '/metadata_templates/:ID'
	 * Method: GET
	 *
	 * @param {string} templateID - The ID to retrieve metadata template for
	 * @param {Function} [callback] - Called with a metadata template when successful
	 * @returns {Promise<Object>} A promise resolving to a metadata template
	 */
