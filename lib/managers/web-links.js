 ...
 */
WebLinks.prototype.create = function(url, parentID, options) {
 ...
 */
WebLinks.prototype.get = function(weblinkID, options) {
 ...
 */
WebLinks.prototype.update = function(weblinkID, updates) {
	var apiPath = urlPath(BASE_PATH, weblinkID),
		params = {
			body: updates
		};
 ...
 */
WebLinks.prototype.delete = function(weblinkID) {
	var apiPath = urlPath(BASE_PATH, weblinkID);
