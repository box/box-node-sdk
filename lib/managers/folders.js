 ...
 *
 * @param {?Object} qs - Additional options can be passed with the request via querystring. Can be left null in most cases.
 * @param {Function} callback - Passed the trashed items information if successful, error otherwise
 * @returns {void}
 */
Folders.prototype.getTrashedItems = function(qs, callback) {

	var params = {
		qs: qs
	};

	var apiPath = urlPath(BASE_PATH, 'trash','items');
	this.client.get(apiPath, params, this.client.defaultResponseHandler(callback));
};
