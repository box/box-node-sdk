...
Webhooks.validateMessage = function(body, headers, primarySignatureKey, secondarySignatureKey, maxMessageAge) {
	if (!primarySignatureKey && Webhooks.primaryKey) {
		primarySignatureKey = Webhooks.primaryKey;
	}

	if (!secondarySignatureKey && Webhooks.secondaryKey) {
		secondarySignatureKey = Webhooks.secondaryKey;
	}
