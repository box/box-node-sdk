 ...
 * @returns {void}
 */
Webhooks.prototype.getWebhooks = function(qs, callback) {

	var params = {
		qs: qs
	};

	var apiPath = urlPath(BASE_PATH); // /webhooks or webhooks?
	this.client.get(apiPath, params, this.client.defaultResponseHandler(callback));
};
...
Webhooks.prototype.deleteWebhook = function(webhookID, callback) {
	var apiPath = urlPath(BASE_PATH, webhookID); 
	this.client.delete(apiPath, params, this.client.defaultResponseHandler(callback));
