...
* @param {string} objectType - Value of 'file' or 'folder'
...
* @returns {void}
*/
Webhooks.prototype.create = function(id, objectType, notificationURL, triggerTypes, callback) {
	var params = {
		body: {
			target: {
				id: id,
...
* @param {string} options.trigger - The new events that triggers a notification
* @param {Function} callback - Passed the webhook information if it was acquired successfully
* @returns {void}
*/
