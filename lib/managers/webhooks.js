...
/**
 * Sets primary signature that is used to verify the Webhooks messages
 *
 * @param {string} primaryKey - The primary signature to verify the message with
 * @returns {void}
 */
Webhooks.setPrimarySignatureKey = function(primaryKey) {
	Webhooks.primarySignatureKey = primaryKey;
};

/**
 * Sets secondary signature that is used to verify the Webhooks messages
 *
 * @param {string} secondaryKey - The secondary signature to verify the message with
 * @returns {void}
 */
Webhooks.setSecondarySignatureKey = function(secondaryKey) {
