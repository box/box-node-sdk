...
Search.prototype = {
	 ...
	 * @param {boolean} [options.are_shared_links_included] - Determines whether to include items accessible only via shared link in the response. To include shared link items, a user must also pass in 'is_only_accessible_via_shared_link' to the fields parameter
