 ...
 */
Groups.prototype.create = function(name, options) {
 ...
 */
Groups.prototype.get = function(groupID, options) {
 ...
 */
Groups.prototype.update = function(groupID, updates) {
 ...
 */
Groups.prototype.addUser = function(groupID, userID, options) {
 ...
 */
Groups.prototype.getMembership = function(membershipID, options) {
 ...
 */
Groups.prototype.updateMembership = function(membershipID, options) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
Groups.prototype.removeMembership = function(membershipID) {
 ...
 */
Groups.prototype.getMemberships = function(groupID, options) {
 ...
 */
Groups.prototype.getAll = function(options) {
 ...
 */
Groups.prototype.getCollaborations = function(groupID, options) {
