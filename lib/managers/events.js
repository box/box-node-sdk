 ...
 */
Events.prototype.getCurrentStreamPosition = function() {
	var params = {
		qs: {
 ...
 */
Events.prototype.get = function(options) {
 ...
 */
Events.prototype.getLongPollInfo = function() {
 ...
 */
Events.prototype.getEventStream = function(streamPosition, options) {

	if (typeof streamPosition === 'string') {

		return Promise.resolve(new EventStream(this.client, streamPosition, options));
	}
	...
	return this.getCurrentStreamPosition()
		.then(currentStreamPosition => new EventStream(this.client, currentStreamPosition, options));
};
 ...
 */
Events.prototype.getEnterpriseEventStream = function(options) {
	return Promise.resolve(new EnterpriseEventStream(this.client, options));
};
