 ...
 */
LegalHoldPolicies.prototype.create = function(name, options) {
 ...
 */
LegalHoldPolicies.prototype.get = function(policyID, options) {
 ...
 */
LegalHoldPolicies.prototype.update = function(policyID, updates) {
 ...
 */
LegalHoldPolicies.prototype.getAll = function(options) {
	var apiPath = urlPath(BASE_PATH),
		params = {
			qs: options
		};
 ...
 */
LegalHoldPolicies.prototype.delete = function(policyID) {
 ...
 */
LegalHoldPolicies.prototype.getAssignments = function(policyID, options) {
 ...
 */
LegalHoldPolicies.prototype.assign = function(policyID, assignType, assignID) {
 ...
 */
LegalHoldPolicies.prototype.getAssignment = function(assignmentID, options) {
 ...
 * @returns {Promise<void>} A promise resolving to nothing
 */
LegalHoldPolicies.prototype.deleteAssignment = function(assignmentID) {
 ...
 */
LegalHoldPolicies.prototype.getFileVersionLegalHold = function(legalHoldID, options) {
 ...
 */
LegalHoldPolicies.prototype.getAllFileVersionLegalHolds = function(policyID, options) {
