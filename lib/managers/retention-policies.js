 ...
 */
RetentionPolicies.prototype.create = function(name, type, action, options) {
 ...
 */
RetentionPolicies.prototype.get = function(policyID, options) {
 ...
 */
RetentionPolicies.prototype.update = function(policyID, updates) {
 ...
 */
RetentionPolicies.prototype.getAll = function(options) {
	var apiPath = urlPath(BASE_PATH),
		params = {
			qs: options
		};
 ...
 */
RetentionPolicies.prototype.getAssignments = function(policyID, options) {
 ...
 */
RetentionPolicies.prototype.assign = function(policyID, assignType, assignID) {
 ...
 */
RetentionPolicies.prototype.getAssignment = function(assignmentID, options) {
 ...
 */
RetentionPolicies.prototype.getFileVersionRetention = function(retentionID, options) {
 ...
 */
RetentionPolicies.prototype.getAllFileVersionRetentions = function(options) {
