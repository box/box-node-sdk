...
function Config(params) {
	...
	if (this.proxyURL) {
		this.request.agentClass = ProxyAgent;
		this.request.agentOptions = Object.assign({}, this.request.agentOptions, url.parse(this.proxyURL));

		if (this.proxyAuth) {
			Object.assign(this.request.agentOptions, {auth: `${this.proxyAuth.username}:${this.proxyAuth.password}`});
		}
	}
