...
/**
 * Returns a valid box token corresponding to the box client instance
 *
 * @returns {Promise} A promise resolving to a token for the client instance
 */
BoxClient.prototype.getToken = function(){
	return this._session.getAccessToken(this._tokenOptions)
}
