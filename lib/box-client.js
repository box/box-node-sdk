...
BoxClient.prototype._createHeadersForRequest = function(callerHeaders, accessToken) {
	...
	Object.assign(headers, { 'X-Box-UA': constructBoxUAHeader() });
 ...
 * @private
 */
BoxClient.prototype._makeRequest = function(params) {
 ...
 */
BoxClient.prototype.revokeTokens = function() {
 ...
 */
BoxClient.prototype.exchangeToken = function(scopes, resource, options) {
 ...
 * @returns {void}
 */
BoxClient.prototype.post = function(path, params) {
	var newParams = merge({}, params || {});
 ...
 * @returns {void}
 */
BoxClient.prototype.put = function(path, params) {
	var newParams = merge({}, params || {});
 ...
 * @returns {void}
 */
BoxClient.prototype.del = function(path, params) {
	var newParams = merge({}, params || {});
 ...
 * @returns {void}
 */
BoxClient.prototype.options = function(path, params) {
	var newParams = merge({}, params || {});
 ...
 * @returns {void}
 */
BoxClient.prototype.upload = function(path, params, formData) {
...
BoxClient.prototype.batchExec = function() {
...
/**
 * Wrap a client method with the default handler
 * @param {Function} method The client method (e.g. client.get)
 * @returns {Function}  The wrapped method
 */
// @TODO(mwiller) 2018-01-25: Consider changing to defaultHandler and thenning into promises instead of wrapping
