...
To apply or update the watermark for a file call the [`files.applyWatermark(fileID, callback)`](http://opensource.box.com/box-node-sdk/Files.html#applyWatermark).

```js
client.files.applyWatermark('67890', callback);
```
