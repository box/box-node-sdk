...
<!-- sample put_tasks_id -->
```ts
await client.tasks.updateTaskById(task.id!, { requestBody: { message: "updated message" } satisfies UpdateTaskByIdRequestBody } satisfies UpdateTaskByIdOptionalsInput)
```
