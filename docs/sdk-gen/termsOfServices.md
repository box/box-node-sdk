...
```ts
await client.termsOfServices.createTermsOfService({ status: "disabled" as CreateTermsOfServiceRequestBodyStatusField, tosType: "managed" as CreateTermsOfServiceRequestBodyTosTypeField, text: "Test TOS" } satisfies CreateTermsOfServiceRequestBody)
```
...
```ts
await client.termsOfServices.updateTermsOfServiceById(tos.id, { status: "disabled" as UpdateTermsOfServiceByIdRequestBodyStatusField, text: "TOS" } satisfies UpdateTermsOfServiceByIdRequestBody)
```
