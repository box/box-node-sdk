...
<!-- sample post_invites -->
```ts
await client.invites.createInvite({ enterprise: { id: currentUser.enterprise!.id! } satisfies CreateInviteRequestBodyEnterpriseField, actionableBy: { login: email } satisfies CreateInviteRequestBodyActionableByField } satisfies CreateInviteRequestBody)
```
