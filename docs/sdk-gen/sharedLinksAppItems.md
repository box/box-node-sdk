...
```ts
await client.sharedLinksAppItems.findAppItemForSharedLink({ boxapi: "".concat("shared_link=", appItemSharedLink) as string } satisfies FindAppItemForSharedLinkHeadersInput)
```
