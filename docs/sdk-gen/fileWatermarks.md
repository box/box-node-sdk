...
```ts
await client.fileWatermarks.updateFileWatermark(file.id, { watermark: new UpdateFileWatermarkRequestBodyWatermarkField({ imprint: "default" as UpdateFileWatermarkRequestBodyWatermarkImprintField }) } satisfies UpdateFileWatermarkRequestBody)
```
