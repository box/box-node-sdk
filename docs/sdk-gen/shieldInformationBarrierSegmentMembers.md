...
```ts
await client.shieldInformationBarrierSegmentMembers.getShieldInformationBarrierSegmentMembers({ shieldInformationBarrierSegmentId: segment.id! } satisfies GetShieldInformationBarrierSegmentMembersQueryParams)
```
