...
```ts
await client.externalUsers.submitJobToDeleteExternalUsersV2025R0({ externalUsers: [new UserReferenceV2025R0({ id: getEnvVar("BOX_EXTERNAL_USER_ID") })] } satisfies ExternalUsersSubmitDeleteJobRequestV2025R0)
```
