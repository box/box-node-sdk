...
- [Supported versions](#supported-versions)
  ...
  - [Deprecation of manually written `box-node-sdk` module](#deprecation-of-manually-written-box-node-sdk-module)
...
## Deprecation of manually written `box-node-sdk` module

The manually written `box-node-sdk` module will be marked as deprecated, will receive only bug fixes and security patches, and reach end of support in 2027.
All new features and support for new Box APIs will be provided exclusively in the `sdk-gen` module.
