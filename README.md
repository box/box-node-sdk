...
With this SDK version, alongside the existing `box-node-sdk` codebase, we’re introducing a new `sdk-gen` module which gives you access to:
...
| 4       | Node.js >= 18           | Supported | 23 Oct 2025   | TBD                    |
