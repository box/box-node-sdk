    ...
    describe('get()', () => {
      it('should make correct request and correctly parse response when API call is successful', (done) => {
        ...
        apiMock
          ...
          .reply(200, fixture);
        basicClient.collaborations.get(collaborationID, null, (err, data) => {
          assert.isNull(err);
    ...
    describe('update()', () => {
      it('should make correct request and correctly parse response when API call is successful', (done) => {
        var collaborationID = '1234567898',
          options = {
            role: basicClient.collaborationRoles.VIEWER_UPLOADER,
          },
      ...
      it('should make correct request and pass error when API call fails', (done) => {
        ...
        apiMock
          ...
          .reply(404, fixture);
        basicClient.collaborations.update(collaborationID, options, (err) => {
          assert.instanceOf(err, Error);
          assert.propertyVal(err, 'statusCode', 404);
          assert.nestedProperty(err, 'response.body');
          assert.deepEqual(err.response.body, JSON.parse(fixture));
    ...
    describe('delete()', () => {
      it('should make correct request and correctly parse response when API call is successful', (done) => {
        ...
        apiMock
          ...
          .reply(204);
        basicClient.collaborations.delete(collaborationID, (err, data) => {
          assert.isNull(err);
    ...
    describe('getItems()', () => {
      it('should make correct request and correctly parse response when API call is successful', (done) => {
        ...
        apiMock
          ...
          .reply(200, fixture);
        basicClient.collections.getItems(collectionID, null, (err, data) => {
          assert.isNull(err);
          assert.deepEqual(data, JSON.parse(fixture));
          done();
        });
  ...
  describe('Files', () => {
    describe('get()', () => {
      ...
      it('should get shared link options', (done) => {
        ...
        apiMock
          ...
          .reply(200, fixture);
        basicClient.files.get(
          fileID,
          { fields: 'shared_link_permission_options' },
          (err, data) => {
            assert.isNull(err);
            assert.deepEqual(data, JSON.parse(fixture));
            done();
    ...
    describe('update()', () => {
      ...
      it('should create a shared link with custom return params', (done) => {
        ...
        const fixture = getFixture(
          'files/put_files_shared_link_custom_params_200'
        );
        apiMock
      ...
      it('should extend the retention policy expiration date for the file', (done) => {
        ...
        const fixture = getFixture(
          'files/put_files_disposition_at_custom_params_200'
        );
        apiMock
    ...
    describe('addToCollection()', () => {
      it('should make correct requests and correctly parse responses when API call is successful', (done) => {
        ...
        basicClient.files.addToCollection(fileID, collectionID, (err, data) => {
          assert.isNull(err);
    ...
    describe('getRepresentationInfo()', () => {
      it('should resolve all representation entries with success status when generateRepresenations option is passed', () => {
        var repsFixtureMultiple = getFixture(
          ...
          repPDFURL = url.parse(
            repsObj.representations.entries[1].info.url
          ).pathname,
          /* eslint-disable node/no-deprecated-api */
          repTextURL = url.parse(
            repsObj.representations.entries[2].info.url
          ).pathname,
      ...
      it('should return representation entries with errors when generateRepresentations option is passed', () => {
        var repsFixture = getFixture(
          ...
          /* eslint-disable node/no-deprecated-api */
          repInfoURL = url.parse(
            repsObj.representations.entries[0].info.url
          ).pathname,
    ...
    describe('promoteVersion()', () => {
      it('should make POST call to make version current', () => {
        ...
        return basicClient.files
          ...
          .then((currentVersion) =>
            assert.deepEqual(currentVersion, JSON.parse(fixture))
          );
      });
    });
    describe('uploadNewFileVersion()', () => {
      it('should make POST request to upload new file version content', () => {
        ...
        uploadMock
          ...
          .reply(201, fixture);
        return basicClient.files
          .uploadNewFileVersion(fileID, fileContent, {
            name,
            description: fileDescription,
          })
    ...
    describe('getEmbedLink()', () => {
      it('should make GET call to retrieve file embed URL', () => {
        ...
        return basicClient.files
          .getEmbedLink(fileID)
          .then((embedURL) =>
            assert.equal(embedURL, JSON.parse(fixture).expiring_embed_link.url)
          );
      });
    });
    describe('lock()', () => {
    ...
    describe('applyWatermark()', () => {
      it('should make PUT call to apply watermark', () => {
        ...
        return basicClient.files
          ...
          .then((watermark) =>
            assert.deepEqual(watermark, JSON.parse(fixture))
          );
      });
    });
    describe('getWatermark()', () => {
      it('should make GET call to retrieve watermark', () => {
        ...
        return basicClient.files
          .getWatermark(fileID)
          .then((watermark) =>
            assert.deepEqual(watermark, JSON.parse(fixture).watermark)
          );
      });
    });
  ...
  describe('Groups', () => {
    ...
    describe('addUser()', () => {
      it('should make POST call to create group membership', () => {
        ...
        return basicClient.groups
          ...
          .then((membership) =>
            assert.deepEqual(membership, JSON.parse(fixture))
          );
      });
    });
    ...
    describe('getMemberships()', () => {
      it('should make GET call to retrieve the group memberships', () => {
        ...
        return basicClient.groups
          ...
          .then((memberships) =>
            assert.deepEqual(memberships, JSON.parse(fixture))
          );
      });
    });
    ...
    describe('terminateSession()', () => {
      it('should make POST call to terminate sessions by group IDs', (done) => {
        ...
        basicClient.groups.terminateSession(groupIDs, (err, result) => {
          assert.ifError(err);
    ...
    describe('getAssignments()', () => {
      it('should make GET call to retrieve assignments', () => {
        ...
        return basicClient.legalHoldPolicies
          ...
          .then((assignments) =>
            assert.deepEqual(assignments, JSON.parse(fixture))
          );
      });
    });
  ...
  describe('Collaboration Allowlists', () => {
    describe('addDomain()', () => {
      it('should make a post request to create a domain collaboration allowlisting', () => {
        ...
        return (
          basicClient.collaborationAllowlist
  ...
  describe('Terms of Service', () => {
    describe('setUserStatus()', () => {
      it('should make a post request to create user status on terms of service, if conflict update', () => {
        ...
        return (
          basicClient.termsOfService
            .setUserStatus(termsOfServiceID, true, {
              user_id: user.id,
            })
            // eslint-disable-next-line promise/always-return
            .then((tosUserStatus) => {
  ...
  describe('Metadata', () => {
    ...
    describe('query()', () => {
      ...
      it('should make POST call to query items based on their metadata using iterators and return correct result when API call succeeds', () => {
        ...
        return (
          iteratorClient.metadata
            .query(from, ancestorFolderId, options)
            .then((iterator) => Promise.all([iterator.next(), iterator.next()]))
            // eslint-disable-next-line promise/always-return
            .then((items) => {
  ...
  describe('Retention Policies', () => {
    ...
    describe('getAllFileVersionRetentions()', () => {
      it('should make GET call to retrieve retentions', () => {
        ...
        return basicClient.retentionPolicies
          ...
          .then((retentions) =>
            assert.deepEqual(retentions, JSON.parse(fixture))
          );
      });
    });
    ...
    describe('getFilesUnderRetentionForAssignment()', () => {
      it('should make GET call to retrieve files under retention for assignment', () => {
        var assignmentID = '444444',
          fixture = getFixture(
            'retention-policies/get_files_under_retention_200'
          );
        apiMock
          .get(
            `/2.0/retention_policy_assignments/${assignmentID}/files_under_retention`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(200, fixture);
        return basicClient.retentionPolicies
          .getFilesUnderRetentionForAssignment(assignmentID)
    ...
    describe('getFileVersionsUnderRetentionForAssignment()', () => {
      it('should make GET call to retrieve file versions under retention for assignment', () => {
        var assignmentID = '444444',
          fixture = getFixture(
            'retention-policies/get_file_versions_under_retention_200'
          );
        apiMock
          .get(
            `/2.0/retention_policy_assignments/${assignmentID}/file_versions_under_retention`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(200, fixture);
        return basicClient.retentionPolicies
          .getFileVersionsUnderRetentionForAssignment(assignmentID)
          .then((files) => assert.deepEqual(files, JSON.parse(fixture)));
      });
    });
  });
    ...
    describe('get()', () => {
      it('should make GET call to retrieve shared item', () => {
        ...
        return basicClient.sharedItems
          .get(link)
          .then((sharedItem) =>
            assert.deepEqual(sharedItem, JSON.parse(fixture))
          );
      });
    });
  });
  ...
  describe('Users', () => {
      ...
      it('should make POST request for setting user avatar and resolve with urls', (done) => {
        var userID = '44444',
          ...
          expectedReturn = {
            pic_urls: {
              small:
                'https://app.box.com/index.php?rm=pic_storage_auth&pic=small',
              large:
                'https://app.box.com/index.php?rm=pic_storage_auth&pic=large',
              preview:
                'https://app.box.com/index.php?rm=pic_storage_auth&pic=preview',
            },
          };
        apiMock
    ...
    describe('terminateSession()', () => {
      it('should make POST request to terminate sessions by user IDs and resolve with message', (done) => {
        ...
        const userLogins = ['user@example.com', 'user2@example.com'];
        const expectedReturn = {
          message:
            'Request is successful, please check the admin events for the status of the job',
        };
        apiMock
          ...
          .reply(201, expectedReturn);
        basicClient.users.terminateSession(
          { user_ids: userIDs, user_logins: userLogins },
          (error, result) => {
            assert.ifError(error);
            assert.deepEqual(result, expectedReturn);
            done();
  ...
  describe('Shield information barriers', () => {
    describe('getById()', () => {
      it('should make GET request for shield information barrier with spcified ID and return correct response when API call succeeds ', () => {
        var shieldInformationBarrierId = '123',
          fixture = getFixture(
            'shield-information-barriers/get_shield_information_barrier_id_200'
          );
        apiMock
          ...
          .reply(200, fixture);
        return (
          basicClient.shieldInformationBarriers
            .getById({
    ...
    describe('getAll()', () => {
      it('should make GET request for shield information barriers and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'shield-information-barriers/get_shield_information_barriers_200'
        );
        apiMock
    ...
    describe('create()', () => {
      it('should make POST request for shield information barrier and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'shield-information-barriers/post_shield_information_barriers_201'
        );
        apiMock
    ...
    describe('changeStatusById()', () => {
      it('should make POST request for shield information barrier status and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'shield-information-barriers/post_shield_information_barriers_id_status_200'
        );
        apiMock
  ...
  describe('Shield information barrier segments', () => {
    describe('getById()', () => {
      it('should make GET request for shield information barrier segment with spcified ID and return correct response when API call succeeds', () => {
        var shieldInformationBarrierSegmentId = '123',
          fixture = getFixture(
            'shield-information-barrier-segments/get_shield_information_barrier_segments_id_200'
          );
        apiMock
          ...
          .reply(200, fixture);
        return (
          basicClient.shieldInformationBarrierSegments
            .getById({
    ...
    describe('getAll()', () => {
      it('should make GET request for shield information barrier segments and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'shield-information-barrier-segments/get_shield_information_barrier_segments_200'
        );
        apiMock
    ...
    describe('create()', () => {
      it('should make POST request for shield information barrier segment and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-segments/post_shield_information_barrier_segments_201'
        );
        apiMock
          .post(
            '/2.0/shield_information_barrier_segments',
            barrierSegmentPostData
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
    ...
    describe('update()', () => {
      it('should make PUT request for shield information barrier segment and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'shield-information-barrier-segments/put_shield_information_barrier_segments_id_200'
        );
        apiMock
  ...
  describe('Shield information barrier segment members', () => {
    describe('getById()', () => {
      it('should make GET request for shield information barrier segment member with spcified ID and return correct response when API call succeeds', () => {
        var shieldInformationBarrierSegmentMemberId = '123',
          fixture = getFixture(
            'shield-information-barrier-segment-members/get_shield_information_barrier_segment_members_id_200'
          );
        apiMock
          ...
          .reply(200, fixture);
        return (
          basicClient.shieldInformationBarrierSegmentMembers
            .getById({
    ...
    describe('getAll()', () => {
      it('should make GET request for shield information barrier segment members and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-segment-members/get_shield_information_barrier_segment_members_200'
        );
        apiMock
          .get(
            `/2.0/shield_information_barrier_segment_members?shield_information_barrier_segment_id=${shieldInformationBarrierSegmentId}`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
    ...
    describe('create()', () => {
      it('should make POST request for shield information barrier segment member and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-segment-members/post_shield_information_barrier_segment_members_201'
        );
        apiMock
          .post(
            '/2.0/shield_information_barrier_segment_members',
            barrierSegmentMemberPostData
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(201, fixture);
        return basicClient.shieldInformationBarrierSegmentMembers.create(
          barrierSegmentMemberPostData
        );
      });
    });
  ...
  describe('Shield information barrier segment restrictions', () => {
    describe('getById()', () => {
      it('should make GET request for shield information barrier segment restriction with spcified ID and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-segment-restrictions/get_shield_information_barrier_segment_restrictions_id_200'
        );
        apiMock
          .get(
            `/2.0/shield_information_barrier_segment_restrictions/${shieldInformationBarrierSegmentRestrictionId}`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(200, fixture);
        return (
          basicClient.shieldInformationBarrierSegmentRestrictions
            .getById({
    ...
    describe('getAll()', () => {
      it('should make GET request for shield information barrier segment restrictions and return correct response when API call succeeds', () => {
        var shieldInformationBarrierSegmentId = '432554';
        var fixture = getFixture(
          'shield-information-barrier-segment-restrictions/get_shield_information_barrier_segment_restrictions_200'
        );
        apiMock
          .get(
            `/2.0/shield_information_barrier_segment_restrictions?shield_information_barrier_segment_id=${shieldInformationBarrierSegmentId}`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
    ...
    describe('create()', () => {
      it('should make POST request for shield information barrier segment restriction and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-segment-restrictions/post_shield_information_barrier_segment_restrictions_201'
        );
        apiMock
          .post(
            '/2.0/shield_information_barrier_segment_restrictions',
            barrierSegmentRestrictionPostData
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(201, fixture);
        return basicClient.shieldInformationBarrierSegmentRestrictions.create(
          barrierSegmentRestrictionPostData
        );
      });
    });
  ...
  describe('Shield information barrier reports', () => {
    describe('getById()', () => {
      it('should make GET request for shield information barrier report with spcified ID and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-reports/get_shield_information_barrier_reports_id_200'
        );
        apiMock
          .get(
            `/2.0/shield_information_barrier_reports/${shieldInformationBarrierReportId}`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(200, fixture);
        return (
          basicClient.shieldInformationBarrierReports
            .getById({
    ...
    describe('getAll()', () => {
      it('should make GET request for shield information barrier reports and return correct response when API call succeeds', () => {
        var shieldInformationBarrierId = '123';
        var fixture = getFixture(
          'shield-information-barrier-reports/get_shield_information_barrier_reports_200'
        );
        apiMock
          .get(
            `/2.0/shield_information_barrier_reports?shield_information_barrier_id=${shieldInformationBarrierId}`
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
    ...
    describe('create()', () => {
      it('should make POST request for shield information barrier report and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'shield-information-barrier-reports/post_shield_information_barrier_reports_201'
        );
        apiMock
          .post(
            '/2.0/shield_information_barrier_reports',
            barrierSegmentReportPostData
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(201, fixture);
        return basicClient.shieldInformationBarrierReports.create(
          barrierSegmentReportPostData
        );
      });
    });
  ...
  describe('Integration mappings', () => {
    describe('getSlackIntegrationMappings()', () => {
      it('should make GET request for Slack integration mappings and return correct response when API call succeeds', () => {
        var fixture = getFixture(
          'integration-mappings/get_integration_mappings_slack_200'
        );
        apiMock
          ...
          .reply(200, fixture);
        return (
          basicClient.integrationMappings
    ...
    describe('createSlackIntegrationMapping()', () => {
      it('should make POST request to create Slack integration mapping and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'integration-mappings/post_integration_mappings_slack_200'
        );
        apiMock
          .post(
          ...
          .reply(201, fixture);
        return basicClient.integrationMappings.createSlackIntegrationMapping(
          integrationMappingSlackCreateRequest
        );
      });
    });
    describe('update()', () => {
      it('should make PUT request to update Slack integration mapping and return correct response when API call succeeds', () => {
        ...
        var fixture = getFixture(
          'integration-mappings/put_integration_mappings_slack_id_200'
        );
        apiMock
          .put(
            `/2.0/integration_mappings/slack/${integrationMappingId}`,
            integrationMappingUpdateData
          )
          .matchHeader('Authorization', (authHeader) => {
            assert.equal(authHeader, `Bearer ${TEST_ACCESS_TOKEN}`);
            return true;
          ...
          .reply(200, fixture);
        return basicClient.integrationMappings.updateSlackIntegrationMapping(
          integrationMappingUpdateData,
          {
