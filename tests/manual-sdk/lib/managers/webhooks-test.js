...
describe('Webhooks', function () {
  ...
  describe('create()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return webhooks
        .create(ID, TYPE, ADDRESS, TRIGGERS)
  ...
  describe('validateMessage()', function () {
    ...
    const HEADERS = {
        ...
        'box-signature-secondary':
          'v+1CD1Jdo3muIcbpv5lxxgPglOqMfsNHPV899xWYydo=',
      ...
      HEADERS_WITH_WRONG_SIGNATURE_VERSION = Object.assign({}, HEADERS, {
        'box-signature-version': '2',
      }),
      HEADERS_WITH_WRONG_SIGNATURE_ALGORITHM = Object.assign({}, HEADERS, {
        'box-signature-algorithm': 'XXX',
      });
    ...
    it('should validate JSON body parsed as Object with Japanese characters', function () {
      ...
      HEADERS['box-signature-primary'] =
        'LV2uCu+5NJtIHrCXDYgZ0v/PP5THGRuegw3RtdnEyuE=';
    ...
    it('should validate JSON body parsed as Object with emoji characters', function () {
      ...
      HEADERS['box-signature-primary'] =
        'xF/SDZosX4le+v4A0Qn59sZhuD1RqY5KRUKzVMSbh0E=';
    ...
    it('should validate JSON body parsed as Object with a url', function () {
      ...
      BODY =
        '{"webhook":{"id":"1234567890"},"trigger":"FILE.UPLOADED","source":{"id":"1234567890","type":"file","name":"Test.txt","shared_link":{"url":"https:\/\/app.test.com\/s\/test123"}}}';
      HEADERS['box-signature-primary'] =
        '+hKJH+wxkEBpkQRag11Ij1Wh4+7QrgUeRe0PPSoGWOI=';
    ...
    it('should validate JSON body parsed as Object with a carriage return', function () {
      ...
      HEADERS['box-signature-primary'] =
        'SVkbKgy3dEEf2PbbzpNu2lDZS7zZ/aboU7HOZgBGrJk=';
