...
describe('Comments', function () {
  ...
  beforeEach(function () {
    ...
    Comments = require(MODULE_FILE_PATH).default;
  ...
  describe('get()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return comments
        .get(COMMENT_ID, testQS)
        .then((data) => assert.equal(data, response));
    });
  });

  describe('create()', function () {
    var fileID, commentText, expectedParams;
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return comments
        .create(fileID, commentText)
        .then((data) => assert.equal(data, response));
    });
  });

  describe('createTaggedComment()', function () {
    var fileID, expectedParams, taggedCommentText;
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return comments
        .create(fileID, taggedCommentText)
        .then((data) => assert.equal(data, response));
    });
  });
