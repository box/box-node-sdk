...
describe('Groups', function () {
  ...
  describe('create()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return groups.create('test').then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('get()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return groups.get(GROUP_ID).then((data) => assert.equal(data, response));
    });
  });

  describe('update()', function () {
    var options, expectedParams;
  ...
  describe('updateMembership()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'put').returns(Promise.resolve(response));
      return groups
        .updateMembership(MEMBERSHIP_ID, options)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getAll()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return groups.getAll().then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getCollaborations()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return groups
        .getCollaborations(GROUP_ID, null)
        .then((data) => assert.equal(data, response));
    });
  });
});
