...
describe('Tasks', function () {
  ...
  beforeEach(function () {
    ...
    Tasks = require(MODULE_FILE_PATH).default;
  ...
  describe('create()', function () {
    var message, dueAt, expectedParams;
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return tasks.create(FILE_ID).then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('delete()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return tasks.delete(TASK_ID).then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getAssignment()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return tasks
        .getAssignment(ASSIGNMENT_ID, testQS)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('assignByUserID()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return tasks
        .assignByUserID(TASK_ID, USER_ID)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('updateAssignment()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'put').returns(Promise.resolve(response));
      return tasks
        .updateAssignment(ASSIGNMENT_ID, options)
        .then((data) => assert.equal(data, response));
    });
  });
