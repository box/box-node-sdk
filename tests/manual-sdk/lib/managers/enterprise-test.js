...
describe('Enterprise', function () {
  ...
  describe('getUsers()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return enterprise.getUsers().then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('inviteUser()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return enterprise
        .inviteUser(ENTERPRISE_ID, TEST_LOGIN)
  ...
  describe('addAppUser()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return enterprise
        .addAppUser(NAME, { job_title: JOB_TITLE })
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('transferUserContent()', function () {
    ...
    it('should pass results to callback when callback is present', function (done) {
      ...
      enterprise.transferUserContent(
        SRC_USER_ID,
        DEST_USER_ID,
        function (err, data) {
          assert.ifError(err);
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return enterprise
        .transferUserContent(SRC_USER_ID, DEST_USER_ID)
        .then((data) => assert.equal(data, response));
    });
  });
});
