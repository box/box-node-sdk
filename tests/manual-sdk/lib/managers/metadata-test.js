...
describe('Metadata', function () {
  ...
  describe('getTemplateSchema()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return metadata
        .getTemplateSchema('enterprise', 'productSpec')
  ...
  describe('createTemplate()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return metadata
        .createTemplate(name, fields, options)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('deleteTemplate()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return metadata
        .deleteTemplate(scope, template)
        .then((data) => assert.equal(data, response));
    });
  });

  describe('updateTemplate()', function () {
    var scope, template, operations;
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return metadata
        .updateTemplate(scope, template, operations)
        .then((data) => assert.equal(data, response));
    });
  });
