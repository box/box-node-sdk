...
describe('Collaborations', () => {
  ...
  describe('get()', () => {
    ...
    it('should get selected fields', () => {
      ...
      sandbox
        ...
        .withArgs('/collaborations/1234', {
          qs: { fields: 'id,is_access_only' },
        })
        .returns(Promise.resolve());
      collaborations.get(COLLABORATION_ID, {
        fields: 'id,is_access_only',
      });
    });
    ...
    it('should return promise resolving to results when called', () => {
      ...
      return collaborations
        .get(COLLABORATION_ID, testQS)
        .then((data) => assert.equal(data, response));
    });
  });

  describe('getPending()', () => {
    let pendingQS, expectedParams;
  ...
  describe('update()', () => {
    ...
    it('should return promise resolving to results when called', () => {
      ...
      return collaborations
        .update(COLLABORATION_ID, testBody)
        .then((data) => assert.equal(data, response));
    });
  });

  describe('respondToPending()', () => {
    let newStatus, expectedParams;
    ...
    it('should pass results to callback when callback is present', (done) => {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'put').yieldsAsync(null, response);
      collaborations.respondToPending(
        COLLABORATION_ID,
        newStatus,
        (err, data) => {
          assert.ifError(err);
    ...
    it('should return promise resolving to results when called', () => {
      ...
      sandbox.stub(boxClientFake, 'put').returns(Promise.resolve(response));
      return collaborations
        .respondToPending(COLLABORATION_ID, newStatus)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('create()', () => {
    ...
    it('should return promise resolving to results when called', () => {
      ...
      return collaborations
        .create(newCollabAccessibleBy, itemID, newCollabRole)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('createWithUserID()', () => {
    ...
    it('should pass results to callback when callback is present', (done) => {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'post').yieldsAsync(null, response);
      collaborations.createWithUserID(
        userID,
        itemID,
        newCollabRole,
        { type: 'file' },
    ...
    it('should return promise resolving to results when called', () => {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return collaborations
        .createWithUserID(userID, itemID, newCollabRole)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('createWithUserEmail()', () => {
    ...
    it('should create collaboration on file when passed the correct type option with additional true parameters', () => {
      ...
      sandbox
        ...
        .expects('post')
        .withArgs('/collaborations', expectedParams);
      collaborations.createWithUserEmail(
        userEmail,
        itemID,
        newCollabRole,
        params
    ...
    it('should return promise resolving to results when called', () => {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return collaborations
        .createWithUserEmail(userEmail, itemID, newCollabRole)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('createWithGroupID()', () => {
    ...
    it('should pass results to callback when callback is present', (done) => {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'post').yieldsAsync(null, response);
      collaborations.createWithGroupID(
        groupID,
        itemID,
        newCollabRole,
        { type: 'file' },
    ...
    it('should return promise resolving to results when called', () => {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return collaborations
        .createWithGroupID(groupID, itemID, newCollabRole)
        .then((data) => assert.equal(data, response));
    });
