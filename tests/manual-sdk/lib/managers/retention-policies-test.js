...
describe('RetentionPolicies', function () {
  beforeEach(function () {
    ...
    RetentionPolicies = require(MODULE_FILE_PATH).default;
  ...
  describe('create()', function () {
    ...
    it('should make POST request to create a new policy when called with optional parameter', function () {
      ...
      sandbox
        ...
        .expects('post')
        .withArgs('/retention_policies', expectedParams);
      retentionPolicies.create(POLICY_NAME, 'finite', DISPOSITION_ACTION, {
        retention_length: 30,
    ...
    it('should pass results to callback when callback is present', function (done) {
      ...
      retentionPolicies.create(
        POLICY_NAME,
        'finite',
        DISPOSITION_ACTION,
        { retention_length: 30, retention_type: 'modifiable' },
        function (err, data) {
          assert.ifError(err);
    ...
    it('should return promise resolving to results when called', function () {
      ...
      return retentionPolicies
        .create(POLICY_NAME, 'finite', DISPOSITION_ACTION, {
          retention_length: 30,
        })
  ...
  describe('update()', function () {
    ...
    it('should make PUT request to update policy info when called', function () {
      ...
      sandbox
        .mock(boxClientFake)
        .expects('put')
        .withArgs(`/retention_policies/${POLICY_ID}`, {
          body: options,
        });
  ...
  describe('getAssignments()', function () {
    it('should make GET request to get assignments when called', function () {
      ...
      sandbox
        .mock(boxClientFake)
        .expects('get')
        .withArgs(`/retention_policies/${POLICY_ID}/assignments`, {
          qs,
        });
  ...
  describe('assign()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'post').returns(Promise.resolve(response));
      return retentionPolicies
        .assign(POLICY_ID, ASSIGN_TYPE, ASSIGN_ID)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getAssignment()', function () {
    ...
    it('should pass results to callback when callback is present', function (done) {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'get').yieldsAsync(null, response);
      retentionPolicies.getAssignment(
        ASSIGNMENT_ID,
        null,
        function (err, data) {
          assert.ifError(err);
  ...
  describe('getFileVersionRetention()', function () {
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return retentionPolicies
        .getFileVersionRetention(RETENTION_ID)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getFilesUnderRetentionForAssignment()', function () {
    it('should make GET request to get retention records when called', function () {
      ...
      sandbox
        ...
        .expects('get')
        .withArgs(
          `/retention_policy_assignments/${POLICY_ID}/files_under_retention`,
          { qs }
        );
    ...
    it('should pass results to callback when callback is present', function (done) {
      ...
      sandbox.stub(boxClientFake, 'wrapWithDefaultHandler').returnsArg(0);
      sandbox.stub(boxClientFake, 'get').yieldsAsync(null, response);
      retentionPolicies.getFilesUnderRetentionForAssignment(
        POLICY_ID,
        null,
        function (err, data) {
          assert.ifError(err);
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return retentionPolicies
        .getFilesUnderRetentionForAssignment(POLICY_ID)
        .then((data) => assert.equal(data, response));
    });
  });
  ...
  describe('getFileVersionsUnderRetentionForAssignment()', function () {
    it('should make GET request to get retention records when called', function () {
      ...
      sandbox
        ...
        .expects('get')
        .withArgs(
          `/retention_policy_assignments/${POLICY_ID}/file_versions_under_retention`,
          { qs }
        );
      retentionPolicies.getFileVersionsUnderRetentionForAssignment(
        POLICY_ID,
        qs
      );
    });
    ...
    it('should return promise resolving to results when called', function () {
      ...
      sandbox.stub(boxClientFake, 'get').returns(Promise.resolve(response));
      return retentionPolicies
        .getFileVersionsUnderRetentionForAssignment(POLICY_ID)
        .then((data) => assert.equal(data, response));
    });
  });
});
