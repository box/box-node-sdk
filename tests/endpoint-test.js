...
const {FileSharedLinkAccess} = require("../lib/managers/files");
...
describe('Endpoint', function () {
	...
	describe('Files', function () {
		describe('get()', function () {
			...
			it('should get shared link', function (done) {
				var fileID = '1234567890',
			...
			it('should get shared link options', function (done) {
				var fileID = '1234567890',
				...
				apiMock
					...
					.reply(200, fixture);
				basicClient.files.get(fileID, {fields: 'shared_link_permission_options'}, function (err, data) {
					assert.isNull(err);
					assert.deepEqual(data, JSON.parse(fixture));
					done();
				});
		...
		describe('update()', function () {
			...
			it('should create a shared link', function (done) {
		...
		describe('getRepresentationInfo()', function () {
			it('should resolve all representation entries with success status when generateRepresenations option is passed', function () {
			...
			it('should return representation entries when the options and representation parameters are not passed', function () {
				var repsFixtureMultiple = getFixture(
					'files/get_files_id_representations_multiple_200'
				);
				var fileID = '11111';
			...
			it('should return representation entries with errors when generateRepresentations option is passed', function () {
		...
		describe('getTemplates()', function () {
			it('should make GET call for template information and return correct result when API call succeeds', function () {
				...
				apiMock
					...
					.reply(200, fixture);
				return basicClient.metadata.getTemplates(scope).then(templates => {
		...
		describe('getAll()', function () {
			it('should make GET request for storage policies and return correct response when API call succeeds', function () {
				...
				apiMock
					...
					.reply(200, fixture);
				return basicClient.storagePolicies.getAll().then(policies => {
					assert.deepEqual(policies, JSON.parse(fixture));
				});
			});
		});
