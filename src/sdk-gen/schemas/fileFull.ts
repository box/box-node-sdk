import { serializeFileBaseTypeField } from './fileBase';
import { deserializeFileBaseTypeField } from './fileBase';
...
import { serializeFilePathCollectionField } from './file';
import { deserializeFilePathCollectionField } from './file';
import { serializeFileSharedLinkField } from './file';
import { deserializeFileSharedLinkField } from './file';
import { serializeFolderMini } from './folderMini';
import { deserializeFolderMini } from './folderMini';
import { serializeFileItemStatusField } from './file';
import { deserializeFileItemStatusField } from './file';
...
import { serializeResourceScope } from './resourceScope';
...
import { FilePathCollectionField } from './file';
import { FileSharedLinkField } from './file';
import { FolderMini } from './folderMini';
import { FileItemStatusField } from './file';
...
export function deserializeFileFull(val: SerializedData): FileFull {
  ...
  const allowedSharedLinkAccessLevels:
    | undefined
    | readonly FileFullAllowedSharedLinkAccessLevelsField[] =
    val.allowed_shared_link_access_levels == void 0
      ? void 0
      : sdIsList(val.allowed_shared_link_access_levels)
