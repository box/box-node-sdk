...
import { serializeAiItemAsk } from './aiItemAsk';
import { deserializeAiItemAsk } from './aiItemAsk';
import { serializeAiDialogueHistory } from './aiDialogueHistory';
import { deserializeAiDialogueHistory } from './aiDialogueHistory';
import { serializeAiAskAgent } from './aiAskAgent';
import { deserializeAiAskAgent } from './aiAskAgent';
...
export interface AiAsk {
  /**
   * Box AI handles text documents with text representations up to 2MB in size, or a maximum of 25 files,
